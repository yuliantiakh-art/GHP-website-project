          ...
          <div className="absolute bottom-0 left-0 w-full p-margin-mobile md:p-xl">
            <div className="max-w-max-width mx-auto">
              ...
              <p className="text-white/90 font-sans text-lg max-w-2xl">
                Bantu menghadirkan mushaf Al-Qur'an untuk masjid, mushala, TPA, dan santri di daerah yang masih memiliki keterbatasan akses.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="flex justify-between items-end mb-4">
              <div>
                ...
                <h3 className="font-display text-headline-lg text-primary">Rp 5.000.000</h3>
              </div>
      ...
      <section className="py-xl max-w-max-width mx-auto px-margin-mobile md:px-gutter grid grid-cols-1 md:grid-cols-12 gap-xl">
        <div className="md:col-span-8">
          <div className="space-y-6">
            ...
            <div className="prose prose-lg text-text-muted font-sans text-lg space-y-4">
              <p>Di pelosok nusantara, masih banyak santri dan jamaah yang harus belajar membaca Al-Qur'an menggunakan lembaran mushaf yang sudah robek dan usang secara bergantian karena minimnya persediaan kitab suci.</p>
              <p>Program Cahaya Qur'an Nusantara hadir sebagai ikhtiar untuk menjangkau titik-titik tersebut. Kami mendistribusikan mushaf baru, layak baca, dan lengkap ke TPA, pondok pesantren, masjid, serta musala di daerah rawan pendidikan dan terpencil.</p>
              <p>Setiap huruf yang mereka baca dan hafalkan, akan terus mengalirkan pahala kebaikan kepada para donatur yang telah memfasilitasi mushaf baru ini. Ini adalah peluang investasi amal jariyah terbaik untuk Anda.</p>
            </div>
            ...
            <div className="pt-lg">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-surface-container-low p-4 rounded-xl text-center group hover:bg-primary-container hover:text-on-primary-container transition-all duration-300">
                  ...
                  <p className="font-display text-headline-md block">1.500</p>
                  <p className="text-caption font-semibold opacity-80 uppercase">Mushaf Baru</p>
                </div>
                <div className="bg-surface-container-low p-4 rounded-xl text-center group hover:bg-primary-container hover:text-on-primary-container transition-all duration-300">
                  ...
                  <p className="font-display text-headline-md block">25</p>
                  <p className="text-caption font-semibold opacity-80 uppercase">Daerah Sasaran</p>
                </div>
                <div className="bg-surface-container-low p-4 rounded-xl text-center group hover:bg-primary-container hover:text-on-primary-container transition-all duration-300">
                  <span className="material-symbols-outlined text-primary mb-2 group-hover:text-on-primary-container text-4xl">groups</span>
                  <p className="font-display text-headline-md block">30</p>
                  <p className="text-caption font-semibold opacity-80 uppercase">Mitra TPA/Masjid</p>
                </div>
                <div className="bg-surface-container-low p-4 rounded-xl text-center group hover:bg-primary-container hover:text-on-primary-container transition-all duration-300">
                  <span className="material-symbols-outlined text-primary mb-2 group-hover:text-on-primary-container text-4xl">sentiment_satisfied</span>
                  <p className="font-display text-headline-md block">2.000+</p>
                  <p className="text-caption font-semibold opacity-80 uppercase">Santri Penerima</p>
                </div>
              </div>
            </div>
        ...
        <div className="md:col-span-4 space-y-gutter">
          <div className="bg-surface-container-high rounded-xl p-6">
            <h4 className="font-bold text-caption text-primary uppercase mb-4 tracking-widest">Informasi Penyelenggara</h4>
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-caption font-semibold text-text-muted">Lembaga Terverifikasi</p>
              </div>
            </div>
            <div className="space-y-3 pt-3 border-t border-outline-variant">
              <div className="flex items-center gap-2 text-text-muted font-semibold text-caption">
                ...
                <span>Periode: Jan 2026 - Des 2026</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
            <div className="relative rounded-xl overflow-hidden group aspect-[4/3]">
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6">
                <p className="text-white text-caption font-semibold">Tebaran Al-Qur'an pertama di masjid binaan pelosok Jawa Barat.</p>
              </div>
            </div>
            <div className="relative rounded-xl overflow-hidden group aspect-[4/3]">
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6">
                <p className="text-white text-caption font-semibold">Penyerahan bantuan mushaf secara simbolis kepada pengurus TPA.</p>
              </div>
            </div>
          </div>
        </div>
